...
function extension_import_files() {
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/default/extension.WordPress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/default/extension-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/default/extension-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/gutenberg/extension-gutenberg.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/gutenberg/extension-gutenberg-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/gutenberg/extension-gutenberg-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/app/extension-app.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/app/extension-app-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/app/extension-app-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/education/extension-education.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/education/extension-education-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/education/extension-education-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/construction/extension-construction.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/construction/extension-construction-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/extension/construction/extension-construction-export.dat',
    ...
    array(
      ...
      'isPlus'                      => true,
      'buy_url'                    => 'https://themefreesia.com/plugins/extension-plus/',
