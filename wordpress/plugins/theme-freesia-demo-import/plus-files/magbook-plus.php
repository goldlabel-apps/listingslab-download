...
function magbook_import_files() {
  return array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/default/magbook.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/default/magbook-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/default/magbook-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/newspaper/magbook.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/newspaper/magbook-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/newspaper/magbook-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/journal/magbook.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/journal/magbook-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/journal/magbook-export.dat',
    ...
    array(
     ...
     'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/publication/magbook.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/publication/magbook-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/magbook/publication/magbook-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/magbook/magbook.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/magbook/magbook-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/magbook/magbook-export.dat',
      'import_preview_image_url'   	 => plugins_url( '/magbook-demo-importer/inc/default/screenshot.jpg', dirname(__FILE__) ),
      'import_notice'                => __( 'Recommended Plugins: Install WooCommerce, Contact Form 7 and Magbook Plus Plugins  to look exactly as in our demo. <br> <br> Thanks for being part of us. If you really like our theme, Please help us <a href="https://wordpress.org/support/theme/magbook/reviews/" target="_blank" rel="nofollow">rating</a> our theme
      	', 'theme-freesia-demo-import' ),
...
function magbook_after_import_setup($selected_import) {
	...
	}elseif('Magbook Publication' === $selected_import['import_file_name'] ){
