...
function supermarket_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/supermarket/supermarket.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/supermarket/supermarket-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/supermarket/supermarket-export.dat',
      ...
      'import_notice'                => __( 'Recommended Plugins: WooCommerce, Max Mega Menu, YITH WooCommerce Wishlist, YITH WooCommerce Quick View and Contact Form 7 Plugins  to look exactly as in our demo. 
        ...
        <br> <br> Thanks for being part of us. If you really like our theme, Please help us <a href="https://wordpress.org/support/theme/supermarket/reviews/" target="_blank" rel="nofollow">rating</a> our theme.
        <br>
    ...
    array(
      ...
      'import_notice'                => __( 'Recommended Plugins: WooCommerce, Max Mega Menu, Once Click Demo import, YITH WooCommerce Wishlist, YITH WooCommerce Quick View and Contact Form 7 Plugins  to look exactly as in our demo. <br>
        <strong> After the demo is installed, your site look a bit messy. So you need to setup slider and Frontpage template from customizer and also setup category from widgets. </strong> <br> <br> Thanks for being part of us. If you really like our theme, Please help us <a href="https://wordpress.org/support/theme/supermarket/reviews/" target="_blank" rel="nofollow">rating</a> our theme.
        <br>
        <a href="https://themefreesia.com/theme-instruction/supermarket-plus/" target="_blank" rel="nofollow">Documentation</a>
         <br>
        <a href="https://youtu.be/vBtlcfVWkkU" target="_blank" rel="nofollow">Video Setup</a>
        ', 'supermarket' ),
...
function supermarket_after_import_setup($selected_import) {
   if ( 'Default Supermarket Plus' === $selected_import['import_file_name'] ) {
   ...
   } elseif ( 'Supermarket Plus' === $selected_import['import_file_name'] ) {
        // Assign menus to their locations.
        $top_menu = get_term_by( 'name', 'Top Menu', 'nav_menu' );
        $main_menu = get_term_by( 'name', 'Main menu', 'nav_menu' );
        $catlog_nav_menu = get_term_by( 'name', 'Catalog Menu', 'nav_menu' );
