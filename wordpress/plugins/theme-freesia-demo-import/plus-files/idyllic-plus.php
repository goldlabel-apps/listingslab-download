...
function idyllic_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/default/idyllic.wordpress.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/default/idyllic-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/default/idyllic-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/fashion/idyllic-fashion.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/fashion/idyllic-fashion-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/fashion/idyllic-fashion-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/interior-architecture/idyllic-interior-architecture.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/interior-architecture/idyllic-interior-architecture-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/interior-architecture/idyllic-interior-architecture-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/creative-agency/idyllic-creative-agency.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/creative-agency/idyllic-creative-agency-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/creative-agency/idyllic-creative-agency-export.dat',
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/non-profit/idyllic-non-profit.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/non-profit/idyllic-non-profit-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'../files/dummy/idyllic/non-profit/idyllic-non-profit-export.dat',
    ...
    array(
      ...
      'categories'                   => array( 'Default'),
      'local_import_file'            => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/idyllic/idyllic-plus.xml',
      'local_import_widget_file'     => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/idyllic/idyllic-plus-widgets.wie',
      'local_import_customizer_file' => trailingslashit( plugin_dir_path( __FILE__ ) ).'dummy/idyllic/idyllic-plus-export.dat',
      'import_notice'                => __( 'Important: You have to set up slider from Customize > Slider Options > Select Category Slider.<br> Portfolio from Customize > Front Page Template > Portfolio Section <br> Latest From Blog from Customize > Front Page Template > Latest From Blog Section <br> Recommended Plugins: Install WooCommerce , Recent Posts Widget With Thumbnails and Contact Form 7 Plugins  to look exactly as in our demo. <br> <br> Thanks for being part of us. If you really like our theme, Please help us <a href="https://wordpress.org/support/theme/idyllic/reviews/" target="_blank" rel="nofollow">rating</a> our theme
        ', 'theme-freesia-demo-import' ),
...
function idyllic_after_import_setup($selected_import) {
   ...
   }elseif('Idyllic Non Profit' === $selected_import['import_file_name'] ){
